...
namespace Jokes2.Controllers
{
    public class JokesController : Controller
    {
        private readonly Jokes2Context _context;

        public JokesController(Jokes2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Jokes != null ? 
                          ...
                          Problem("Entity set 'Jokes2Context.Jokes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Jokes2Context.Jokes'  is null.");
            }
            var jokes = await _context.Jokes.FindAsync(id);
            if (jokes != null)
            {
